...
class Checkout extends Component {
    ...
    submitHandler = () => {
        ...
        axios.post('https://burger-builder-8d2d5-default-rtdb.firebaseio.com/orders.json', order)
            .then(response => {
        ...
        let form = (<div>
            ...
            <form style={{
                ...
                <Button style={{ backgroundColor: "#D70F64" }} className="mr-auto"
                    onClick={this.submitHandler} disabled={!this.props.purchaseable}>Place Order</Button>
